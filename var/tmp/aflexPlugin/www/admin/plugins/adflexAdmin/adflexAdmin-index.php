...
/**
 *
 * @author tuannv tuannv@adflex.vn
 *
 * $Id$
 *
 */

require_once('adflexAdmin-common.php');
...
function &buildForm()
{
    $form = new OA_Admin_UI_Component_Form("adflexAdminForm", "POST", $_SERVER['PHP_SELF'], null, array("enctype"=>"multipart/form-data"));
    $form->forceClientValidation(true);

    $form->addElement('header', 'header', "adflexAdmin");
...
{
    phpAds_PageHeader('adflexAdmin-menu-i','','../../');

    $oTpl = new OA_Plugin_Template('adflexAdmin.html', 'adflexAdmin');
    //$oTpl->debugging = true;
