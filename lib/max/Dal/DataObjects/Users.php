...
class DataObjects_Users extends DB_DataObjectCommon
{
    ...
    public $user_address;                    // VARCHAR(255) => openads_varchar => 130 
    public $user_phone;                    // VARCHAR(255) => openads_varchar => 130 
    ...
    var $defaultValues = array(
                ...
                'user_address' => OX_DATAOBJECT_NULL,
                );
