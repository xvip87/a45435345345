...
//require_once MAX_PATH . '/www/admin/plugins/adflexReport/lib/common.php';
require_once MAX_PATH . '/www/admin/plugins/adflexReport/lib/Factory.php';
require_once MAX_PATH . '/lib/pear/Date.php';
//include '/www/admin/plugins/adflexReport/lib/php-ofc-library/open-flash-chart.php';
...
try {
    $oStatsController = &Www_Admin_Plugins_AdflexReport_Lib_Factory::getController($entity . "-" . $breakdown, $aParams);
} catch(Exception $e) {
    OA::debug('aha', $e->getMessage());
}

//echo '<pre/>';
//print_r($oStatsController);
//print_r($oStatsController->templateDir);
//exit();
