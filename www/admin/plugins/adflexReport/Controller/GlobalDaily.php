 ...
 */
class Www_Admin_Plugins_AdflexReport_Controller_GlobalDaily extends OA_Admin_Statistics_Delivery_CommonCrossHistory
{
     ...
     *                       would result in $this->foo = bar.
     */
    function Www_Admin_Plugins_AdflexReport_Controller_GlobalDaily($aParams)
    {
