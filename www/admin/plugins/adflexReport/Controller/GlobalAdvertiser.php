...
require_once MAX_PATH . '/www/admin/plugins/adflexReport/lib/Delivery/CommonEntity.php';
 ...
 */
class Www_Admin_Plugins_AdflexReport_Controller_GlobalAdvertiser extends Www_Admin_Plugins_AdflexReport_Lib_Delivery_CommonEntity
{
