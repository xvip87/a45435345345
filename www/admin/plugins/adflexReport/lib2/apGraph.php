...
require_once MAX_PATH.'/www/admin/plugins/adflexReport/lib2/open-flash-chart-object.php';
require_once MAX_PATH.'/www/admin/plugins/adflexReport/lib2/open-flash-chart.php';
...
class AP_Graph
{
    ...
    {
        $url = $graph ? 'adflex-json' : 'adflexReport-index';
        $url .= '.php?&breakdown=history&entity='.$this->entity;
    ...
    protected function getController()
    {
        ...
        $GLOBALS['_MAX']['PREF']['ui_column_revenue'] = true;
        $GLOBALS['_MAX']['PREF']['ui_column_revenue_rank'] = 3;
