...
require_once MAX_PATH . '/www/admin/plugins/adflexReport/lib/Delivery/Common.php';
 ...
 */
class Www_Admin_Plugins_AdflexReport_Lib_Delivery_CommonHistory extends Www_Admin_Plugins_AdflexReport_Lib_Delivery_Common
{
     ...
     */
    function Www_Admin_Plugins_AdflexReport_Lib_Delivery_CommonHistory($params)
    {
