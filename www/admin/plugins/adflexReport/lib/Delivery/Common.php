...
require_once MAX_PATH . '/www/admin/plugins/adflexReport/lib/Delivery/Flexy.php';
...
class Www_Admin_Plugins_AdflexReport_Lib_Delivery_Common extends Www_Admin_Plugins_AdflexReport_Lib_Delivery_Flexy
{
    ...
    function __construct($aParams)
    {
        ...
        $this->templateDir = MAX_PATH . '/www/admin/plugins/adflexReport/templates/';
     ...
     *                       would result in $this->foo = bar.
     */
    function Www_Admin_Plugins_AdflexReport_Lib_Delivery_Common($aParams)
    {
    ...
    {
        require_once MAX_PATH . '//www/admin/plugins/adflexReport/lib/Fields/Delivery/Default.php';
        $aPlugins['default'] = & new OA_StatisticsFieldsDelivery_Default();
        require_once MAX_PATH . '/www/admin/plugins/adflexReport/lib/Fields/Delivery/Affiliates.php';
