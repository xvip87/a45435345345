 ...
 */
class Www_Admin_Plugins_AdflexReport_Lib_Delivery_CommonEntity extends OA_Admin_Statistics_Delivery_Common
{
    ...
    var $entityLinks = array(
            'a' => 'adflexReport-index.php?entity=advertiser&breakdown=history',
            'c' => 'adflexReport-index.php?entity=campaign&breakdown=history',
            'b' => 'adflexReport-index.php?entity=banner&breakdown=history',
            'p' => 'adflexReport-index.php?entity=affiliate&breakdown=history',
            'z' => 'adflexReport-index.php?entity=zone&breakdown=history'
        );
    ...
    function getAdvertisers($aParams, $level, $expand = '')
    {
        ...
        foreach ($aAdvertisers as $advertiserId => $advertiser) {
            ...
            if ($this->startLevel > $level || !$this->hideInactive || $advertiser['active']) {
                ...
                $advertiser['conversionslink'] = "adflexReport-index.php?entity=conversions&clientid={$advertiserId}";
