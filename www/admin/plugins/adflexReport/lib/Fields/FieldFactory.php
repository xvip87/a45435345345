...
require_once MAX_PATH . '/www/admin/plugins/adflexReport/lib/Fields/DaySpanField.php';
...
class FieldFactory
{
    ...
    function &newField($fieldType)
    {
        switch ($fieldType) {
            ...
            case 'date-month':           $oField = new Admin_UI_DaySpanFieldAdflex(); break;
            case 'day-span':             $oField = new Admin_UI_DaySpanFieldAdflex(); break;
            case 'day-span-selector':    $oField = new Admin_UI_DaySpanFieldAdflex(); break;
