...
require_once MAX_PATH . '/www/admin/plugins/adflexReport/lib/Fields/Delivery.php';
/**
 ...
 */
class OA_StatisticsFieldsDelivery_Default extends OA_StatisticsFieldsDeliveryAdflex
{
    /**
     * Constructor
     */
    function OA_StatisticsFieldsDelivery_Default()
    {
        ...
        $this->_aFields['sum_conversions'] =
            array(
                ...
                'link'    => 'adflexReport-index.php?entity=conversions&',
                'active'  => true,
                'format'  => 'default',
                'ctf'     => true
            );
