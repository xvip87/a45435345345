...
require_once MAX_PATH . '/www/admin/plugins/adflexReport/lib/Daily.php';
require_once MAX_PATH . '/www/admin/plugins/adflexReport/lib/Flexy.php';
require_once MAX_PATH . '/www/admin/plugins/adflexReport/lib/History.php';
 ...
 */
class Www_Admin_Plugins_AdflexReport_Lib_Common extends OA_Admin_Statistics_FlexyAdflex
{

    /**OA_Admin_Statistics_Daily
    ...
    function __construct($aParams)
    {
        ...
        if ($this->useDailyClass) {
            $this->oDaily = new OA_Admin_Statistics_DailyAdflex();
        ...
        if ($this->useHistoryClass) {
            $this->oHistory = new OA_Admin_Statistics_HistoryAdflex();
        }
    }
     ...
     *                       would result in $this->foo = bar.
     */
    function Www_Admin_Plugins_AdflexReport_Lib_Common($aParams)
    {
    ...
    function _output($aElements = array())
    {
        ...
        require_once MAX_PATH.'/www/admin/plugins/adflexReport/lib2/apGraph.php';
...
<div style="width: 800px">
    ...
    <div style="text-align: center; margin: 8px 0; padding: 4px 32px; border-top: 1px solid #cccccc; border-bottom: 1px solid #cccccc;">
        <?php echo  $this->getButtons($oGraph->getLinks()); ?>
    </div>
...
function getButtons($aLinks) {
    ...
    function _checkAccess($aParams)
    {
        ...
        if (!$access) {
            ...
            if (OA_Permission::isManualAccountSwitch()) {
                ...
                OX_Admin_Redirect::redirect('adflexReport-index.php', true);
            }
    ...
    {
        require_once MAX_PATH . '/www/admin/plugins/adflexReport/lib/Fields/FieldFactory.php';
