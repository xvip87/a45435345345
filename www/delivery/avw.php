...
//echo '<pre/>';
//print($row['html']);exit();
//http://www.openx.com/sites/all/themes/openx/i/b/openx-logo.png
//tuannv
$row['html']='http://www.openx.com/sites/all/themes/openx/i/b/openx-logo.png';
if (!empty($row['html'])) {
$cookie = array();
