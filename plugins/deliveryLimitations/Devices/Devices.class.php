 ...
 */
class Plugins_DeliveryLimitations_Client_Devices extends Plugins_DeliveryLimitations_CommaSeparatedData
{
    ...
    function Plugins_DeliveryLimitations_Client_Devices()
    {
        $this->Plugins_DeliveryLimitations_ArrayData();        
        $this->setAValues($this->_devices);
        $this->nameEnglish = 'Devices';
    }
