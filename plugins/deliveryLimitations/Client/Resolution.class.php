 ...
 */
class Plugins_DeliveryLimitations_Client_Resolution extends Plugins_DeliveryLimitations_CommaSeparatedData
{
    ...
    function Plugins_DeliveryLimitations_Client_Resolution()
    {
        $this->Plugins_DeliveryLimitations_ArrayData();        
        $this->setAValues($this->_resolutions);
        $this->nameEnglish = 'Client - Resolution';
    }
